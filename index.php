                    ...
                    <div class="banner-form">
                        <form class="form-inline" action="search.php" method="GET">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input name="search" type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to eat...."> </div>
                            </div>
                            <button type="submit" name="ok" class="btn theme-btn btn-lg">Search food</button>
                        </form>
                    </div>
                    <div class="steps">
